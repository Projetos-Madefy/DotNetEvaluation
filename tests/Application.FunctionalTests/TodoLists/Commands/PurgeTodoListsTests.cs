using DotNetEvaluation.Application.Common.Exceptions;
using DotNetEvaluation.Application.Common.Security;
using DotNetEvaluation.Application.TodoLists.Commands.CreateTodoList;
using DotNetEvaluation.Application.TodoLists.Commands.PurgeTodoLists;
using DotNetEvaluation.Domain.Entities;

namespace DotNetEvaluation.Application.FunctionalTests.TodoLists.Commands;
