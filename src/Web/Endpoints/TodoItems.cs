using DotNetEvaluation.Application.Common.Models;
using DotNetEvaluation.Application.TodoItems.Commands.CreateTodoItem;
using DotNetEvaluation.Application.TodoItems.Commands.DeleteTodoItem;
using DotNetEvaluation.Application.TodoItems.Commands.UpdateTodoItem;
using DotNetEvaluation.Application.TodoItems.Commands.UpdateTodoItemDetail;
using DotNetEvaluation.Application.TodoItems.Queries.GetTodoItemsWithPagination;
